    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        body{background:var(--sys-bg);font-family:'Inter',sans-serif;overflow:hidden;min-height:100vh;min-height:100dvh;color:var(--sys-text);}
        ...
        .p3app{width:100vw;min-height:100vh;min-height:100dvh;background:radial-gradient(140% 100% at 75% 0%,var(--sys-bg-flare) 0%,rgba(0,0,0,0) 55%),var(--sys-bg);position:relative;overflow:hidden;}
        ...
        .p3sel{display:flex;flex-direction:column;align-items:center;min-height:100vh;min-height:100dvh;padding:30px 26px 82px;position:relative;z-index:10;animation:p3up .6s ease forwards;overflow-y:auto;scrollbar-width:thin;scrollbar-color:rgba(111,173,255,.35) transparent;}
        ...
        .p3cr{display:flex;flex-direction:column;min-height:100vh;min-height:100dvh;position:relative;z-index:10;animation:p3up .5s ease forwards;}
